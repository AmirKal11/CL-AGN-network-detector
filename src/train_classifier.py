...
def train_single_config(
    ...
    result = {
        ...
        "dataset_config": {
            "processed_catalog": config["data"].get("processed_catalog", "unknown"),
        ...
        "augmentations": {
            "apply_masking_prob": 1.0,  # Based on Data_handler logic for train set
            "broad_line_mask": {
                "min_frac": 0.05,
                "max_frac": 0.30,
                "prob": 0.6
            ...
            "redshift_jitter": {
                "shift_max": 5,
                "prob": 1.0  # Applied unconditionally to shift != 0
            },
            "resolution_smearing": {
                "blur_prob": 0.3,
...
def train_model():
    ...
    models_dir = os.path.join(BASE_DIR, "models/backbone_with_redshift_jitter/", "backbone_sweep")
